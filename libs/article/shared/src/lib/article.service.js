...
var ArticleService = /** @class */ (function (_super) {
    ...
    function ArticleService(config, http) {
        var _this = _super.call(this, config, http) || this;
        _this.http = http;
        return _this;
    }
    Object.defineProperty(ArticleService.prototype, "endpoint", {
        get: function () {
            return 'articles';
        },
        enumerable: false,
    ...
    ArticleService.prototype.getFeed = function (req, query, loading) {
        var _this = this;
        if (loading === void 0) { loading = true; }
        var url = this.getURLFromEndpoint({ endpoint: 'articles/feed' });
    ...
    ArticleService.prototype.favoriteArticle = function (slug, loading) {
        var url = this.getURLFromEndpoint({ endpoint: "articles/" + slug + "/favorite" });
        this.setLoading(loading ? 'show' : 'not-show');
        var options = __assign({}, this.defaultOptions);
        return this.http.post(url, null, options);
    };
    ArticleService.prototype.unfavoriteArticle = function (slug, loading) {
        var url = this.getURLFromEndpoint({ endpoint: "articles/" + slug + "/favorite" });
        this.setLoading(loading ? 'show' : 'not-show');
        var options = __assign({}, this.defaultOptions);
